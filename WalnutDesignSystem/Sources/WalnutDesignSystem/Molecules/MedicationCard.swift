...
public enum MedicationTimePeriod: CaseIterable {
    case morning
    case afternoon
    case evening
    case night
...
public struct MedicationCard: View {
    ...
    private let timePeriod: MedicationTimePeriod?
    ...
    public init(
        ...
        timePeriod: MedicationTimePeriod? = nil,
    ...
    @ViewBuilder
    private func timePeriodIndicator(timePeriod: MedicationTimePeriod) -> some View {
